...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // console.log($('.main-header .navigation li.dropdown ul').length);
        if ($('.main-header .navigation li.dropdown ul').length) {
            // console.log("tsret11111");
            ...
            $('.main-header .navigation li.dropdown .dropdown-btn').on('click', function () {
                ...
                if($(this.children)[0].classList.contains("active")){
                    ...
                    $(this).prev('ul').prev('a').addClass("active");
                }
                //  console.log($(this.children[0])[0].className);
            });
        ...
        if ($('.section-boardofdirector .testimonial-seven-slider').length) {
            $('.section-boardofdirector .testimonial-seven-slider').slick({
                centerMode: false,
                variableWidth: true,
                dots: true,
                infinite: true,
        ...
        if ($('.section-managementteam .testimonial-seven-slider').length) {
            $('.section-managementteam .testimonial-seven-slider').slick({
                centerMode: false,
                variableWidth: true,
                dots: true,
                infinite: true,
